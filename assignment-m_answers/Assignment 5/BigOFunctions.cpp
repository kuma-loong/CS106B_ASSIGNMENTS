 ...
 */
int countTriples(const Vector<int>& values, int target) { //n3
    int result = 0;
 ...
 */
void printCycle_v1(Vector<int>& values) { //n2
    for (int i = 0; i < values.size(); i++) {
        int first = values[0];
 ...
 */
void printCycle_v2(Vector<int>& values) { //n2
    for (int i = 0; i < values.size(); i++) {
        int first = values[0];
 ...
 */
void printCycle_v3(Queue<int>& values) { //n
    for (int i = 0; i < values.size(); i++) {
 ...
 * the runtime.
 */
int recursiveEnigma(int n) {  //logn
    if (n == 0) {
        return 1;
    }
 ...
 */
int maximumSingleSellProfit_v1(const Vector<int>& values) { //n2
 ...
 */
int maximumSingleSellProfit_v2(const Vector<int>& values) {   //nlogn
