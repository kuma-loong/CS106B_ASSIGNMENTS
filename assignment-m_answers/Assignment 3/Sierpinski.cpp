...
void drawSierpinskiTriangle(GWindow& window,
    ...
    if (order == 0) {
        ...
        drawSierpinskiTriangle ( window, x1, y1, (x1+x2)/2, (y1+y2)/2, (x1+x0)/2, (y1+y0)/2, order-1);
        drawSierpinskiTriangle ( window, x2, y2, (x2+x0)/2, (y2+y0)/2, (x2+x1)/2, (y2+y1)/2, order-1);
    }
}
